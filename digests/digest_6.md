...
This should not involve significant changes to the code. In the array that gives the staring array describing states of all nodes, 
some nodes will be in the state 3 - vaccinated. Then, at each epidemic step nothing happens to these nodes - they will stay in state 
3 forever.
...
Yes, I have posted it already - see "Current Tasks". 
